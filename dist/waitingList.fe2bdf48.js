...
},{"../utils/utils.js":"scripts/utils/utils.js"}],"scripts/waitingLists/newWaitingListTable.js":[function(require,module,exports) {
"use strict";
...
var _GroupModal = require("../groupLists/GroupModal.js");
...
WaitingList.prototype.newTable = function (wlData) {
  ...
  wlTable.classList.add('table-style'); //   wlTable.style.display = 'none';
  ...
  wlData.forEach((student, i) => {
    ...
    const studentRowContent = `
            ...
            <div class="table-cell age-cell"><i class="age-icon far fa-calendar-alt"></i>${student.birth_date}</div>
...
},{"../utils/utils.js":"scripts/utils/utils.js","../groupLists/GroupModal.js":"scripts/groupLists/GroupModal.js"}],"node_modules/flatpickr/dist/flatpickr.js":[function(require,module,exports) {
var define;
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/flatpickr/dist/themes/dark.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"scripts/waitingLists/waitingListForm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.waitingListForm = waitingListForm;

var _flatpickr = _interopRequireDefault(require("flatpickr"));

var _utils = require("../utils/utils.js");

var _waitingList = require("./waitingList.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// eslint-disable-next-line import/no-cycle
// Style for date picker
require('flatpickr/dist/themes/dark.css'); // Creates and opens modal for group list item
...
function waitingListForm(modal) {
  ...
  (0, _utils.modalClose)(modal, innerModal); // Selecting form and form tabs, also index for first tab

  const formSubmit = document.querySelector('.as-form');
  const formTab = document.querySelectorAll('.tab'); // Date format with flatpickr

  (0, _flatpickr.default)('.flatpickr', {
    dateFormat: 'd.m.Y'
  }); // Current tab index

  let currentTabIndex = 0; // Shows first tab of the form
  ...
  showFormTab(currentTabIndex); // Form validation
  ...
  function formValidation() {
    ...
    formInputs.forEach(input => {
      console.log(); // Error messages element
  ...
  function formSubmitData(e) {
    ...
    fetch(url, {
      method: 'POST',
      body: JSON.stringify((0, _utils.getKeyValuesPairs)(formSubmit)),
      headers: {
    ...
    (0, _waitingList.fetchData)();
  }

  formSubmit.addEventListener('submit', formSubmitData);
}
},{"flatpickr":"node_modules/flatpickr/dist/flatpickr.js","../utils/utils.js":"scripts/utils/utils.js","./waitingList.js":"scripts/waitingLists/waitingList.js","flatpickr/dist/themes/dark.css":"node_modules/flatpickr/dist/themes/dark.css"}],"scripts/waitingLists/waitingList.js":[function(require,module,exports) {
"use strict";
...
var _newWaitingListTable = require("./newWaitingListTable.js");

var _waitingListForm = require("./waitingListForm.js");

const addItem = document.querySelector('.wl-add-item');
const formModal = document.querySelector('.modal');
const innerFormModal = formModal.firstElementChild;
const formSubmit = document.querySelector('.as-form');
const wlwrapper = document.querySelector('.group-list'); // Submits waiting lists form data to server
...
async function fetchData() {
  ...
  const newList = new _newWaitingListTable.WaitingList(data, wlwrapper);
  return newList;
}

fetchData();
addItem.addEventListener('click', () => (0, _waitingListForm.waitingListForm)(formModal));
},{"../utils/utils.js":"scripts/utils/utils.js","./newWaitingListTable.js":"scripts/waitingLists/newWaitingListTable.js","./waitingListForm.js":"scripts/waitingLists/waitingListForm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/waitingLists/waitingList.js"], null)
//# sourceMappingURL=/waitingList.fe2bdf48.js.map